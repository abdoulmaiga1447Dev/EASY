...
export const FleetWorkspace: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-dark text-white-premium">
      ...
      <header className="lg:hidden sticky top-0 z-30 flex items-center justify-between px-4 h-14 border-b border-gold/10 bg-dark">
      ...
      <div className="lg:flex">
        ...
        {/* Barre latérale : tiroir sur mobile, fixe sur grand écran */}
        <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-dark border-r border-gold/10 flex flex-col transform transition-transform duration-200 lg:sticky lg:top-0 lg:h-screen lg:translate-x-0 lg:z-auto ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
